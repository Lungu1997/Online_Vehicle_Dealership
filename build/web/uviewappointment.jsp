...
<%
 ...
 String q1 = "SELECT * FROM `appointment` WHERE `username` = '"+username+"'";
 Statement st1 = con.createStatement();
 ResultSet rs1 = st1.executeQuery(q1);
 if(rs1.next()){
 
 String q = "SELECT * FROM `appointment` WHERE `username` = '"+username+"'";
...
<div class="card-columns">
  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <p class="card-text"><b>Model: </b> <%=rs.getString("model")%> <br><b>Year: </b> <%=rs.getString("year")%> <br><b>Price: </b> <%=rs.getString("price")%> Euro <br><b>Turnover: </b><%=rs.getString("turnover")%> km<br/>Date: </b> <%=rs.getString("date")%> <br></p>
      <a href="cancelappointment.jsp?model=<%=rs.getString("model")%>&year=<%=rs.getString("year")%>&price=<%=rs.getString("price")%>&turnover=<%=rs.getString("turnover")%>&brand=<%=rs.getString("brand")%>&date=<%=rs.getString("date")%>"><button type="button" class="btn btn-outline-danger">Cancel Reservation</button></a>
