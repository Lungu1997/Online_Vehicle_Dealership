...
<div class="card-columns">
  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <a href="ufeedback1.jsp?model=<%=rs.getString("model")%>&year=<%=rs.getString("year")%>&price=<%=rs.getString("price")%>&turnover=<%=rs.getString("turnover")%>&image=<%=rs.getString("image")%>&brand=<%=rs.getString("brand")%>"><button class="btn btn-outline-danger">Feedback</button></a>    
