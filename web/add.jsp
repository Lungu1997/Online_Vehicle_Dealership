...
<div style="background-color:white">
    ...
    <form action="addmodelsact.jsp" method="post">
        <tr><th>Select</th><th><select  name="brand" required="" style="width:198px">
        ...
        <tr>
            <th>Vehicle Type</th>  <th><input type="text" placeholder="Vehicle Type" name="vehicle type" required="" autocomplete="off"></th></tr>   
        <tr>
            <th>Price</th>  <th><input type="text" placeholder="Price" name="price" required="" autocomplete="off"></th></tr>
        <tr>
            <th>Turnover</th><th> <input type="text" placeholder="Turnover" name="turnover" required="" autocomplete="off"> </th></tr>
        <tr>
            <th>Cubic Capacity</th><th><input type="text" placeholder="Cubic Capacity" name="cc" required="" autocomplete="off">  </th></tr>
        <tr>
            <th>Power</th><th><input type="text" placeholder="Power" name="power" required="" autocomplete="off">  </th></tr>
        <tr>
            <th>Seating</th><th> <input type="text" placeholder="Seating Capacity" name="seating" required="" autocomplete="off">  </th></tr>
        <tr>
            <th>Image</th><th><input type="file" placeholder="Image" name="image" required="" autocomplete="off">  </th></tr>
        <tr>
