...
<div id="mySidebar" class="sidebar">
  <a href="javascript:void(0)" class="closebtn" onclick="closeNav()"> x</a>
   <a href="#m1">Models</a>
	...
	<a href="lowtohigh.jsp?model=up"><h5><li>Up and Coming</li></h5></a>
	</div>
  <a href="#m1">Price</a>
	<div id="list">
...
<div class="card-columns">
 ...
 String q = "SELECT * FROM `models` WHERE `power` < 150";
 Statement st = con.createStatement();
 ResultSet rs = st.executeQuery(q);
...
<div class="card-columns">
 ...
 String q = "SELECT * FROM `models` WHERE `power` >= 150 AND `turnover` < 10000";
 Statement st = con.createStatement();
 ResultSet rs = st.executeQuery(q);
