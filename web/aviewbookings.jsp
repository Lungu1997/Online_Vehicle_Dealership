...
<div class="card-columns">
  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <p class="card-text"><b>Model: </b> <%=rs.getString("model")%> <br><b>Vehicle Type: </b><%=rs.getString("vehicle type")%> <br><b>Year: </b> <%=rs.getString("year")%> <br><b>User: </b> <%=rs.getString("username")%> <br><b>Price: </b> <%=rs.getString("price")%> Euro <br><b>Turnover: </b><%=rs.getString("turnover")%> km<br><b>Power: </b><%=rs.getString("power")%> hp<br/></br><%=rs.getString("cc")%> cc</br><%=rs.getString("seating")%> seater</br></p>
