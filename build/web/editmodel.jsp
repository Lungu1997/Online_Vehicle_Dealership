...
<script>alert('Succesful Update!')</script>
 <%
}
%> 
...
<br><Br><center>
    <h2 style="color:black">Edit model</h2>
    <table>
    <form action="editmodelact.jsp" method="post">
        ...
        <tr>
            <th> </th><th><input type="submit" value="Edit"> </th></tr>
