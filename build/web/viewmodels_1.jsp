...
<nav class="navbar navbar-expand-lg navbar-dark"  style="background-color:#000000;" >
   ...
   &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp   &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp  &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp  &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp  &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
 		<img src="logo.png" height="15%" width="10%"  alt="">&nbspAUTOVINTAGE.com
  		...
  		<a href="index.html" class="btn btn-danger active" role="button" aria-pressed="true" data-toggle="tooltip" data-placement="bottom" title="Back to home">Home</a>
	</nav>
...
<div class="card-columns">
  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <p class="card-text"> <%=rs.getString("year")%> </br><%=rs.getString("vehicle type")%> </br><%=rs.getString("price")%> Euro </br><%=rs.getString("turnover")%> km</br><%=rs.getString("power")%> hp</br><%=rs.getString("cc")%> cc</br><%=rs.getString("seating")%> seater</br></p>
	
            <a href="bookcar.jsp?model=<%=rs.getString("model")%>"><button class="btn btn-outline-danger">Buy</button></a>
            <a href="bookcar.jsp?model=<%=rs.getString("model")%>"><button class="btn btn-outline-danger1">Reserve</button></a>
